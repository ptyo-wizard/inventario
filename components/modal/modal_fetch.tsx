...
const ModalFetch = ({open,setOpen,stateFetch,accept,messages}:ModalConfirmProps) => {
    ...
    const bodyConfirmModal = (
                   ...
                   
        {
                ...
                <Typography className={classes.textLoading} align="center">
                    {messages?.loading}
                </Typography>
        ...
        }
        {
                stateFetch.isSucces && !stateFetch.isFailed  &&(
                    <div>
                        <Typography className={classes.textSuccess} align="center">
                            {messages?.success}
                        </Typography>
